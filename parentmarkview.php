...
<div class="card">
    ...
    <h5 class="card-header info-color white-text text-center py-4">
        <strong style="color: black;">View Child's Marks</strong>
    </h5>
        ...
        <form class="text-center" style="color: black;" method="POST">
            ...
            <div class="md-form mt-0">
              <label for="">Parent ID</label>
                <input type="" id="" class="form-control" name="pid">
  ...
  <div class="card-body">
    ...
    <thead>
			...
			if(isset($_POST['submit']))
			{
				...
				where g.session='$session' AND g.courseid='$subid' AND g.classid='$cid' AND g.studentid='$sid' AND g.term='$tid' AND g.parentid='$pid' ";  
