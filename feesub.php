...
<body class="feesub">
  ...
  ?>
          ...
          <div class="a">
            ...
            <div class="card">
                ...
                <h5 class="card-header info-color white-text text-center py-4">
                    <strong style="color: black;">Fee Submission Form</strong>
                </h5>
               ...
               <div class="md-form">
                   ...
                   <input type="number" id="" class="form-control" aria-describedby="" name="session">
   ...
   if(isset($_POST['submit']))
   {
    ...
    $query= "INSERT into payment (studentid,amount,date,classid,session)values('$id','$amount','$date','$classid','$session')";

    $res=mysqli_query($conn,$query);
    if($res){
       echo "<script type='text/javascript'>alert('Fee Submission successfully!')</script>";
   }else{
       echo "<script type='text/javascript'>alert('Fee Submission unsuccessfull!')</script>";
   }
}
