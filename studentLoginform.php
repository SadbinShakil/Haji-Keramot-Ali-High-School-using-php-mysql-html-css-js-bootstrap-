...
<body class="bg">
	...
	<!--<h2 align="center" color="black" font-weight=30px>Student Login Form</h2>
		<form  method="POST" action="studentloginvalidate.php" align="center">
		...
		<h2 align="center" font-weight=30px><b>Student Login Form</b></h2>


		<section class="container-fluid">
			<section class="row justify-content-center">
				<section class="col-12 col-sm-6 col-md-3">
					<form class="form-container" method="POST" action="studentloginvalidate.php">
